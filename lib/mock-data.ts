...
export const mockTrends: TrendDataPoint[] = [
  { date: "2025-06-01", deepfakes: 40, total: 3800 },
  { date: "2025-07-01", deepfakes: 48, total: 4100 },
  { date: "2025-08-01", deepfakes: 55, total: 4600 },
  { date: "2025-09-01", deepfakes: 62, total: 5000 },
  { date: "2025-10-01", deepfakes: 71, total: 5300 },
  { date: "2025-11-01", deepfakes: 78, total: 5700 },
  { date: "2025-12-01", deepfakes: 85, total: 6100 },
  { date: "2026-01-01", deepfakes: 95, total: 6500 },
  { date: "2026-02-01", deepfakes: 108, total: 7000 },
  { date: "2026-03-01", deepfakes: 120, total: 7600 },
  { date: "2026-04-01", deepfakes: 134, total: 8100 },
  { date: "2026-05-01", deepfakes: 142, total: 8500 },
]
...
export const mockCases: Case[] = [
  ...
  },
  {
    ...
    details: {
      ...
      project_info: {
        case_id: "9e8d7c6b-5a4f-4b7c-945f-abcdef123456",
        examiner_name: "auto-examiner-doc",
        project_id: "59230",
        date_processed: "2026-02-08T13:45:00Z",
        verify_version: "2.374",
        reference_library_version: "2.2.187",
      },
      file_summary: {
        filename: "id-document-scan.jpg",
        format: "MPEG-4 Media File",
        file_id: "161518",
        date_processed: "2026-02-08T13:45:00Z",
        date_last_updated: "2026-02-08T13:46:00Z",
        file_checksum_sha256: "A1B2C3D4E5F6A7B8C9D0E1F2A3B4C5D6E7F8A9B0C1D2E3F4A5B6C7D8E9F0A1B2",
        verify_file_signature: "camera.5678",
      },
      structural_analysis: {
        structure_signature: "Camera Original",
        match_type: "camera.5678",
      ...
      device_generation_history: [
        {
          ...
          model: "iPhone 15 Pro",
          camera_type: "Device Camera",
          processing_steps: ["Rear Camera", "GPS On"],
        },
      ],
      file_signature_structure: [
        { atom: "ftyp", percentage: 100.0 },
        { atom: "moov", percentage: 99.1 },
        { atom: "mdat", percentage: 98.3 },
      ],
      attribute_similarity_analysis: {
        brand: "Apple",
        last_generation: "iPhone 15 Pro",
        model: "Device Camera",
      },
      pixel_analysis: [
        {
      ...
      forensic_analysis: [
        {
          severity: "benign",
          name: "Camera Original - Apple iPhone 15 Pro",
          type: "Device Camera",
          found_in: "File Structural Signature",
        },
      ],
      ...
      decoded_metadata: {
        general: {
          complete_name: "/tmp/id-document-scan.mp4",
          format: "MPEG-4",
          format_profile: "Base Media",
          codec_id: "isom (isom/iso2/avc1/mp41/qt)",
          file_size: "512 KiB",
          duration: "12 s 340 ms",
          overall_bit_rate: "4 500 kb/s",
          writing_application: "Apple iPhone 15 Pro",
        },
        video: {
          id: 1,
          format: "AVC",
          ...
          bit_depth: "8 bits",
          scan_type: "Progressive",
          bits_per_pixel_frame: "0.071",
          stream_size: "500 KiB (98%)",
      ...
      unknown_structural_data: false,
      checks: {
        face_swap: { detected: false, confidence: 0.04 },
        lip_sync: { detected: false, confidence: 0.02 },
        audio_visual_mismatch: { detected: false, confidence: 0.01 },
        injection_attack: { detected: false, confidence: 0.01 },
        replay_attack: { detected: false, confidence: 0.01 },
      },
      metadata: {
  ...
  },
  {
    ...
    details: {
      ...
      project_info: {
        case_id: "3a2b1c4d-5e6f-7a8b-9c0d-ef1234567890",
        examiner_name: "auto-examiner-video",
        project_id: "59232",
        date_processed: "2026-02-05T14:55:00Z",
        verify_version: "2.374",
        reference_library_version: "2.2.187",
      },
      file_summary: {
        filename: "uploaded-video-uncertain.webm",
        format: "WebM Media File",
        file_id: "161519",
        date_processed: "2026-02-05T14:55:00Z",
        date_last_updated: "2026-02-05T14:56:20Z",
        file_checksum_sha256: "C1D2E3F4A5B6C7D8E9F0A1B2C3D4E5F6A7B8C9D0E1F2A3B4C5D6E7F8A9B0C1D2",
        verify_file_signature: "rl.2048",
      },
      structural_analysis: {
      ...
      device_generation_history: [
        ...
        },
        {
          ...
          model: "Re-wrap",
          camera_type: "Encoder",
          processing_steps: ["Save", "Transcode"],
        },
      ],
      file_signature_structure: [
        { atom: "EBML", percentage: 100.0 },
        { atom: "Segment", percentage: 45.2 },
        { atom: "Cluster", percentage: 38.7 },
      ],
      attribute_similarity_analysis: {
        brand: null,
        last_generation: "FFmpeg",
        model: null,
      },
      pixel_analysis: [
        {
          ...
          result: "valid",
          confidence: 0.32,
          description: "Low-confidence analysis. Unable to make a definitive determination.",
        },
        {
          type: "ai_generated_content",
          result: "valid",
          confidence: 0.28,
          description: "No clear AI-generated content detected, but confidence is low.",
        },
      ],
      voice_analysis: [],
      forensic_analysis: [
        {
          severity: "suspect",
          name: "Signature Consistent With: FFmpeg, Lavf encoder. Missing original camera metadata.",
          type: "Encoder",
          found_in: "File Structural Signature",
        },
      ],
      ...
      decoded_metadata: {
        general: {
          complete_name: "/tmp/uploaded-video-uncertain.webm",
          format: "WebM",
          format_profile: "",
          codec_id: "webm",
          file_size: "8.5 MiB",
      ...
      unknown_structural_data: false,
      checks: {
        face_swap: { detected: false, confidence: 0.25 },
        lip_sync: { detected: false, confidence: 0.15 },
        audio_visual_mismatch: { detected: false, confidence: 0.10 },
        injection_attack: { detected: false, confidence: 0.05 },
        replay_attack: { detected: false, confidence: 0.08 },
      },
      metadata: {
